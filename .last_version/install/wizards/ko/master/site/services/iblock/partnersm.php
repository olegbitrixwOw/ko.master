...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/partnersm.xml"; 
$iblockCode = "partnersm_".WIZARD_SITE_ID; 
$iblockType = "products"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("PARTNERSM_IBLOCK_ID" => $iblockID));
?>
