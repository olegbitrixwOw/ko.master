...
$iblockCode = "servicesm_".WIZARD_SITE_ID; 
$iblockType = "products"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("SERVICESM_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/index.php", array("SERVICESM_IBLOCK_ID" => $iblockID));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/services/.left.menu_ext.php", array("SERVICESM_IBLOCK_ID" => $iblockID));
?>
