...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/why.xml"; 
$iblockCode = "why_".WIZARD_SITE_ID; 
$iblockType = "products"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("WHY_IBLOCK_ID" => $iblockID));
?>
