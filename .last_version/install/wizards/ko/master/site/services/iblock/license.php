...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/license.xml"; 
$iblockCode = "license_".WIZARD_SITE_ID; 
$iblockType = "products"; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/license/index.php", array("LICENSE_IBLOCK_ID" => $iblockID));
?>
