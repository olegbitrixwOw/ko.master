...
$i++;
?>
     <div id="entryID<?=$i;?>" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
                                                <div class="col-sm-8 col-md-12 col-lg-8">
                                                    <div class="element relative">
                                                        <a class="absolute" href="<? echo $arSection['SECTION_PAGE_URL']; ?>"></a>
...
<div class="element-img" style="background: url(<? echo $arSection['PICTURE']['SRC']; ?>) 50% 50% no-repeat; background-size: cover;"></div>
                                                        </div>
